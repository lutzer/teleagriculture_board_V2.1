...
enum ValueOrder {
  ...
  MV, MGL, MSCM, PH, DBA, DEPTH, UV_I, RGB, ANGLE, KOHM, DEGREE, SPEED
};
...
enum SensorsImplemented {
  ...
  DFR_FLAME, DHT_11, BMP_680, BH_1750, SHT_21, LTR_390, SPF_WINDVANE, SPF_ANEMOMETER
};
